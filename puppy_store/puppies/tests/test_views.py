...
class GetAllPuppiesTest(TestCase):
    '''
        Teste Module for GET all puppies API
    '''
    ...
    def setUp(self):
        ...
        Puppy.objects.create(
            name='Test', age=1, breed='Fila', color="White")
...
class GetSinglePuppyTest(TestCase):
    ...
    def test_get_invalid_single_puppy(self):
        response = client.get(reverse('get_delete_update_puppy', kwargs={'pk': 0}))
...
class CreateNewPuppyTest(TestCase):
    ...
    def test_create_invalid_puppy(self):
        response = client.post(
            reverse('get_post_puppies'),
            data = json.dumps(self.invalid_playload),
            content_type = 'application/json'
        )
        print(response.data)
...
class DeleteSinglePuppyTest(TestCase):
    ...
    def test_invalid_delete_puppy(self):
        response = client.delete(
            reverse('get_delete_update_puppy', kwargs={'pk': 0}))
